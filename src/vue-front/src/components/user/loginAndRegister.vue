            ...
            <div class="signin-signup">
                ...
                <form action="#" class="sign-up-form">
                    ...
                    <el-form :model="registerForm" :rules="rules" ref="registerForm"   >
                        ...
                        <el-input class=" register-input"  placeholder="请输入用户名"  v-model="registerForm.user_name" style="width: 300px;"></el-input>
                            </div>   
                        </el-form-item>
                        ...
                        <el-input class=" register-input"  placeholder="3-18位,只能包含数字、大小写字母" type="password" v-model="registerForm.password" show-password style="width: 300px;"></el-input>
                            </div>   
                        </el-form-item>
                        ...
                        <el-button type="primary" icon="el-icon-s-promotion" :loading="loading" class="btn " style="margin-top: 0px;" @click="register('registerForm')">立即注册</el-button>
                        </el-form-item>
                    </el-form>
