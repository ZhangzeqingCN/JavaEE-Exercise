                    ...
                    <el-form :model="loginForm" :rules="rules" ref="loginForm">
                        <div style="margin-right: 30px;">
                            <el-form-item prop="username" class="hover">
                                <div style="display: flex;justify-content: center; align-items: center;">
                                    <el-button icon="el-icon-user" circle
                                        style="font-size: 20px;margin-right: 10px;"></el-button>
                                    <el-input class=" login-input" placeholder="请填写用户名" v-model="loginForm.username"
                            ...
                            <el-form-item prop="password" class="hover" v-show="!isCode" style="width: 100%;">
                                <div style="display: flex;justify-content: center; align-items: center;">
                                    <el-button icon="el-icon-key" circle
                                        style="font-size: 20px;margin-right: 10px;"></el-button>
                                    <el-input class=" login-input" placeholder="请填写 3-18 位密码" type="password"
                        ...
                        <el-form-item>
                            <el-button type="primary" icon="el-icon-s-promotion" :loading="loading" class="btn "
                                @click="loginToHome('loginForm')">登 录</el-button>
                        </el-form-item>
                    </el-form>
                ...
                <form action="#" class="sign-up-form">
                    ...
                    <el-form :model="registerForm" :rules="rules" ref="registerForm">
                        <div style="margin-right: 56px;">
                            ...
                            <el-form-item prop="user_name" class="hover" v-show="!isCode"
                                style="margin-top: 0px;margin-bottom: 13px;">
                                <div style="display: flex;justify-content: center; align-items: center;">
                                    <span slot="label" class="register-span">用户名</span>
                                    <el-input class=" register-input" placeholder="请输入用户名" v-model="registerForm.user_name"
                                        style="width: 300px;"></el-input>
                                </div>
                            </el-form-item>
                            <el-form-item prop="password" class="hover" v-show="!isCode"
                                style="margin-top: 0px;margin-bottom: 13px;">
                                <div style="display: flex;justify-content: center; align-items: center;">
                                    <span slot="label" class="register-span">密码</span>
                                    <el-input class=" register-input" placeholder="3-18位,只能包含数字、大小写字母" type="password"
                                        v-model="registerForm.password" show-password style="width: 300px;"></el-input>
                                </div>
                            </el-form-item>
                            <el-form-item prop="passwordConfirm" class="hover" v-show="!isCode"
                                style="margin-top: 0px;margin-bottom: 13px;">
                                <div style="display: flex;justify-content: center; align-items: center;">
                                    <span slot="label" class="register-span">确认密码</span>
                                    <el-input class=" register-input" placeholder="必须与上面输入的密码一致" type="password"
                                        v-model="registerForm.passwordConfirm" show-password
                                        style="width: 300px;"></el-input>
                                </div>
                            </el-form-item>
                            <el-form-item prop="email" class="hover" style="margin-top: 0px;margin-bottom: 13px;">
                                <div style="display: flex;justify-content: center; align-items: center;">
                                    ...
                                    <el-input class=" register-input" placeholder="请填写电子邮件" v-model="registerForm.email"
                                        style="width: 300px;"></el-input>
                                </div>
                            </el-form-item>
                            <el-form-item prop="phone" class="hover" style="margin-top: 0px;margin-bottom: 13px;">
                                <div style="display: flex;justify-content: center; align-items: center;">
                                    ...
                                    <el-input class=" register-input" placeholder="请填写电话号码" v-model="registerForm.phone"
                                        style="width: 300px;"></el-input>
                                </div>
                            </el-form-item>
                        ...
                        <el-form-item style="margin-top: 0px;">
                            <el-button type="primary" icon="el-icon-s-promotion" :loading="loading" class="btn "
                                style="margin-top: 0px;" @click="register('registerForm')">立即注册</el-button>
                        </el-form-item>
                    </el-form>
